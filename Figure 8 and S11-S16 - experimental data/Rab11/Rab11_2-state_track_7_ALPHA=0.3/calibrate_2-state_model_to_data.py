...
init_seed = 7 #choose accordingly to dataset used?
type_dataset = 'Rab11'
...
init_cov_matrix = np.array([np.diag(np.array([100, 100, 0.1, 0.1, 10]))
...
def theta_init_uniform(seed):
    ...
    theta = ((np.array([4000, -4000, 8.0, 8.0, 100])*rand_vec)
